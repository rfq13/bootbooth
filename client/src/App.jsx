...
import { WS_URL, API_URL, BACKOFFICE_SOCKET_URL, appName } from "./constants";
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-100 via-primary-50 to-white">
      <div className="container mx-auto px-6 py-8">
        ...
        <header className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary-100 to-primary-600 rounded-full mb-4 shadow-lg animate-glow">
