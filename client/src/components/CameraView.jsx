      ...
      <div className="aspect-video bg-gradient-to-br from-primary-50 to-primary-100 relative">
        ...
        <div className="absolute bottom-4 left-4 right-4 sm:left-6 sm:right-6 flex justify-center sm:justify-between pointer-events-auto">
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-md border border-primary-200 rounded-2xl px-3 py-2 shadow-soft">
            {[
              { key: "none", label: "Normal", icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M3 7a2 2 0 012-2h3l2-2h4l2 2h3a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M12 17a4 4 0 100-8 4 4 0 000 8z" />
                </svg>
              ) },
              { key: "fisheye", label: "Fish Eye", icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M2.25 12C3.5 7.5 7.5 4.5 12 4.5s8.5 3 9.75 7.5C20.5 16.5 16.5 19.5 12 19.5S3.5 16.5 2.25 12z" />
              ...
              { key: "sepia", label: "Sepia", icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M12 3v3m0 12v3m9-9h-3M6 12H3m13.657 6.657l-2.121-2.121M8.464 8.464L6.343 6.343m12.314 0l-2.121 2.121M8.464 15.536l-2.121 2.121" />
                </svg>
              ) },
              ...
              >
                <span className={`w-5 h-5 ${currentEffect === eff.key ? "text-white" : "text-secondary-700"}`}>{eff.icon}</span>
                <span className="hidden sm:inline font-medium">{eff.label}</span>
              </button>
            ))}
          </div>
        </div>
