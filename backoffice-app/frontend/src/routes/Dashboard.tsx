      ...
      (async () => {
        ...
        if (gs && ScrollTrigger) {
          ...
          const icons = Array.from(
            document.querySelectorAll<HTMLElement>(".icon-anim")
          );
          icons.forEach((i) => {
          ...
          const cards = Array.from(
            document.querySelectorAll<HTMLElement>(".card-anim")
          );
          cards.forEach((c) => {
            c.addEventListener("mouseenter", () => {
              (gs as any).to(c, { y: -5, duration: 0.2, ease: "power2.out" });
            });
            c.addEventListener("mouseleave", () => {
              (gs as any).to(c, { y: 0, duration: 0.2, ease: "power2.out" });
            });
          });
        }
      })();
    ...
    <div className="space-y-6">
      ...
      {!realtimeOk && (
        <div className="text-sm text-[#dc3545]">
          Realtime offline: configure VITE_SSE_URL or VITE_WS_URL
        </div>
      )}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <Card className="bg-[#F8E7D6]">
          ...
          <div className="text-[#22c55e] text-sm">
            ▲ 14.9% <span className="text-[#6c757d]">(+43.21%)</span>
          </div>
        </Card>
        ...
        <Card className="bg-[#EAEFFB]">
          ...
          <div className="text-[#22c55e] text-sm">
            ▲ 25.4% <span className="text-[#6c757d]">(+20.11%)</span>
          </div>
        </Card>
        <Card className="bg-[#E9F7FF]">
          ...
          <div className="text-[#22c55e] text-sm">
            ▲ 35.2% <span className="text-[#6c757d]">(+$754)</span>
          </div>
        </Card>
            ...
            <Table>
              ...
              <Tbody>
                ...
                <Tr>
                  ...
                  <Td>26 Jun 2025</Td>
                  <Td>
                    <Badge className="badge-danger">Canceled</Badge>
                  </Td>
                </Tr>
                <Tr>
                  <Td>Headphone</Td>
                  ...
                  <Td>20 Jun 2025</Td>
                  <Td>
                    <Badge className="badge-success">Shipped</Badge>
                  </Td>
                </Tr>
              </Tbody>
            </Table>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <div className="flex-1">
                  ...
                  <span className="block text-xs text-[#6c757d]">
                    ID: 2441310
                  </span>
                </div>
